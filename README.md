...
# Creating a Retail Chatbot in Slack using Watson Conversation, Discovery and Database Services
...
*  Follow the directions in your browser to select a username, password and team name
